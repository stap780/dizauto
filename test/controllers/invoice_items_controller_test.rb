...
class InvoiceItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invoice_item" do
    assert_difference("InvoiceItem.count") do
      post invoice_items_url, params: { invoice_item: { discount: @invoice_item.discount, invoice_id: @invoice_item.invoice_id, price: @invoice_item.price, product_id: @invoice_item.product_id, quantity: @invoice_item.quantity, sum: @invoice_item.sum, vat: @invoice_item.vat } }
    end
  ...
  test "should update invoice_item" do
    patch invoice_item_url(@invoice_item), params: { invoice_item: { discount: @invoice_item.discount, invoice_id: @invoice_item.invoice_id, price: @invoice_item.price, product_id: @invoice_item.product_id, quantity: @invoice_item.quantity, sum: @invoice_item.sum, vat: @invoice_item.vat } }
