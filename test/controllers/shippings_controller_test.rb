...
class ShippingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipping" do
    assert_difference("Shipping.count") do
      post shippings_url, params: { shipping: { address: @shipping.address, date: @shipping.date, name: @shipping.name, order_id: @shipping.order_id, phone: @shipping.phone, time_from: @shipping.time_from, time_to: @shipping.time_to } }
    end
  ...
  test "should update shipping" do
    patch shipping_url(@shipping), params: { shipping: { address: @shipping.address, date: @shipping.date, name: @shipping.name, order_id: @shipping.order_id, phone: @shipping.phone, time_from: @shipping.time_from, time_to: @shipping.time_to } }
