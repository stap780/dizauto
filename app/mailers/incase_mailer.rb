class IncaseMailer < ApplicationMailer
    ...
    before_action { @email_setup,@incase, @strah, @subject, @content, @receiver = params[:email_setup],params[:incase],params[:strah], params[:subject], params[:content], params[:receiver] }
    before_action :set_from_email
    after_action :set_delivery_options

    def send_info_email
        @strah_email = 'panaet80@gmail.com'#@strah.email
        ...
        attachments["info_email1.xlsx"] = {mime_type: Mime[:xlsx], content: xlsx, encoding: 'base64'}
        mail(to: @receiver,
