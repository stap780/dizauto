# ReturnsController < ApplicationController
class ReturnsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @return.save
        format.html { redirect_to return_url(@return), notice: t('.success') }
  ...
  def destroy
    ...
    respond_to do |format|
      ...
      format.html { redirect_to returns_url, notice: t('.success') }
  ...
  def return_params
    params.require(:return).permit(
      ...
      :return_status_id,
      :invoice_id,
      return_items_attributes: [:id, :variant_id, :price, :discount, :sum, :quantity, :vat, :_destroy]
    )
  end
